...
import com.module.core.extensions.beVisibleIf
...
class BottomActionMenuView : LinearLayout {
    ...
    private fun animateChildTo(
        targetY: Int, duration: Long, interpolator: TimeInterpolator, visible: Boolean = false
    ) {
        currentAnimator = animate().translationY(targetY.toFloat()).setInterpolator(interpolator)
