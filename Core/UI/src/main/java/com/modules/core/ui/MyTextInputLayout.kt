...
import com.module.core.extensions.value
    ...
    fun setColors(textColor: Int, accentColor: Int) {
        try {
            ...
            defaultTextColor.set(
                this, ColorStateList(arrayOf(intArrayOf(0)), intArrayOf(hintColor))
            )
            ...
            focusedTextColor.set(
                this, ColorStateList(arrayOf(intArrayOf(0)), intArrayOf(accentColor))
            )
            ...
            val boxColorState = ColorStateList(
                arrayOf(
                    ...
                    defaultHintTextColor, accentColor
                )
            )
            ...
            defaultTextColor.set(
                this, ColorStateList(arrayOf(intArrayOf(0)), intArrayOf(defaultHintTextColor))
            )
