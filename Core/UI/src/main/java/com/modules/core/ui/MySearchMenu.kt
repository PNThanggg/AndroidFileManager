...
import com.module.core.extensions.onTextChangeListener
import com.module.core.extensions.removeBit
import com.module.core.extensions.showKeyboard
import com.modules.core.ui.databinding.MenuSearchBinding
...
class MySearchMenu(context: Context, attrs: AttributeSet) : AppBarLayout(context, attrs) {
    ...
    private val binding by lazy {
        MenuSearchBinding.inflate(LayoutInflater.from(context), this, true)
    }
...
//        (context as? AppCompatActivity)?.updateTopBarColors(binding.topToolbar, backgroundColor)
//    }
}
