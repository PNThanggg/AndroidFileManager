...
class BottomActionMenuPopup(
    private val activity: AppCompatActivity, items: List<BottomActionMenuItem>
) {
    ...
    constructor(activity: AppCompatActivity, @MenuRes menuResId: Int) : this(
        activity, BottomActionMenuParser(activity).inflate(menuResId)
    )
