package com.modules.core.ui.bottomactionmenu
...
import com.module.core.extensions.windowManager
import com.module.core.utils.isSdkR
import com.modules.core.ui.R
import com.modules.core.ui.databinding.ItemActionModePopupBinding
...
class BottomActionMenuItemPopup(
    ...
    private val popupListAdapter = object : ArrayAdapter<BottomActionMenuItem>(
        context, R.layout.item_action_mode_popup, items
    ) {
    ...
    fun show(anchorView: View) {
        ...
        PopupWindowCompat.setWindowLayoutType(
            popup, WindowManager.LayoutParams.TYPE_APPLICATION_SUB_PANEL
        )
    ...
    private fun buildDropDown() {
        ...
        val dropDownList = ListView(context).apply {
            ...
            elevation = 3f
            setPaddingRelative(
                popupPaddingStart, popupPaddingTop, popupPaddingEnd, popupPaddingBottom
            )
        }

        val screenWidth = if (isSdkR()) {
            context.windowManager.currentWindowMetrics.bounds.width()
        } else {
            @Suppress("DEPRECATION") context.windowManager.defaultDisplay.width
        }
